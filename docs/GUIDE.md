...
Version 0.1.0 · engine id `xray-by-looplet` · Python 3.11 · 406/406 tests passing
...
2. **Run the full suite:** `python -m pytest tests -q` — expect `406 passed`.
...
Full results in `docs/ACCURACY.md`. Summary: **406/406 tests pass**, and every
