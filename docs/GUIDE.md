...
Version 0.1.0 · engine id `xray-by-looplet` · Python 3.11 · 422/422 tests passing
...
2. **Run the full suite:** `python -m pytest tests -q` — expect `422 passed`.
...
Full results in `docs/ACCURACY.md`. Summary: **422/422 tests pass**, and every
