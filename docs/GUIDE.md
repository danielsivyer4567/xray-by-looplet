...
Version 0.1.0 · engine id `xray-by-looplet` · Python 3.11 · 349/349 tests passing
...
2. **Run the full suite:** `python -m pytest tests -q` — expect `349 passed`.
...
Full results in `docs/ACCURACY.md`. Summary: **349/349 tests pass**, and every
