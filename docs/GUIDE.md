...
Version 0.1.0 · engine id `xray-by-looplet` · Python 3.11 · 393/393 tests passing
...
2. **Run the full suite:** `python -m pytest tests -q` — expect `393 passed`.
...
Full results in `docs/ACCURACY.md`. Summary: **393/393 tests pass**, and every
